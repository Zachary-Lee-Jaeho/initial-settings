...
""" vim-plug plugin manager {{{
    ...
    hi Search guibg=LightGreen guifg=wheat
...
""" User interface {{{
    """ Syntax highlighting {{{
        ...
        """ textwidth autonewline auto newline
...
""" General settings {{{
    ...
    set numberwidth=10                              " 99999 lines
    set shortmess+=I                                " disable startup message
    set splitbelow                                  " splits go below w/focus
    set splitright                                  " vsplits go right w/focus
    set ttyfast                                     " for faster redraws etc
    set ttymouse=xterm2                             " experimental
    set clipboard=unnamedplus                        " X11 clipboard syncing with vim buffer
    """ Folding {{{
...
""" Keybindings {{{
    """ General {{{
        ...
        " Ctags default binding to list definitions
        nnoremap <C-]> g<C-]>
